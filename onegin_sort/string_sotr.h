...
typedef int (comparator)(const void* const first_element, const void* const second_element, const size_t size);
...
int ptr_str_cmp        (const void* const first_element, const void* const second_element, const size_t size);
